...
from dataloaders_PJ import PJImageDataset, PJVideoDataset, PJTwoStreamDataset
from data_augmentation import transform_train, transform_val
from models import CNN_timm, CNN_3D, TwoStream
...
parser.add_argument(
    "--train_dir",
    type=str,
    default="D:\data\PJ\\flows",
    help="path to training directory ",
)
parser.add_argument(
    "--test_dir", type=str, default="D:\data\PJ\\flows", help="path to test directory"
)
parser.add_argument(
    "--batch_size", type=int, default=128, help="batch size (default: 32)"
)
parser.add_argument(
...
parser.add_argument(
    "--saved_path",
    type=str,
    default="./runs/flow_emd.pth",
    help="path to the saved model",
)
parser.add_argument(
    "--summary_path",
    type=str,
    default="./runs/flow_emd",
...
def run():
    wandb.init(project="PJ", entity="bnamazi", settings=wandb.Settings(code_dir="."))
    ...
    validation_dataset = PJVideoDataset(
        data_dir=args.test_dir,
        transform=transform_val,
        positional_encoding=args.positional_encoding,
        train=False,
