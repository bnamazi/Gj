...
ANNOTATION_PATH = "D:/data/PJ/1- Annotations/New Annotations Final"
VIDEOS_PATH = "D:/data/PJ/2- Videos"
IMAGES_PATH = "D:/data/PJ/images/"

num_videos = 100
num_steps = 7

steps_dic = {
    "1.1 Anterior Mattress Sutures": 1,
    "1.2 Tying Mattress Sutures": 2,
    "2.1 Enterotomy": 3,
    "3.1 Posterior Duct Sutures": 4,
    "3.2 Anterior Duct Sutures": 5,
    "4.1 Anterior Buttress Sutures": 6,
    "Nothing": 0,
}

NUM_FRAME_PER_STEP = 200  # CLACULATED BASED ON THE MEDIAN
...
#     with open(f"{ANNOTATION_PATH}/{video}/PJ_final.txt", "r") as f:
#         lines = f.readlines()
...
# median of all steps in all videos = 223.5
...
def create_txt_train(video, annotated):
    ...
    if video_name in annotated:
        ...
        with open(f"{ANNOTATION_PATH}/{video_name}/PJ_final.txt", "r") as f:
            lines = f.readlines()
            video_length = convert_time_to_sec(
                lines[-1].split(" : ")[1].split("(")[1].split(",")[1].split(")")[0]
            )
...
if __name__ == "__main__":
    ...
    train_videos = annotated_videos[:60]
    val_videos = annotated_videos[60:70]
    test_videos = annotated_videos[70:]
